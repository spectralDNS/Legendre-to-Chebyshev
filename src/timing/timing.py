...
plt.loglog(
           ...
           #time[:, 0], time2[:, 1], 'r',
           TH[:, 0], TH[:, 1], 'r',
           TH_saga[:, 0], TH_saga[:, 1], 'r:',
           #TH[:, 0], TH[:, 2], 'm',
           plan[:, 0], plan[:, 1], 'k:',
           dct[:, 0], dct[:, 1], 'g',
           direct_osx[:-2, 0], direct_osx[:-2, 1], 'k',
           time[:, 0], time[:, 0]*time[3, 1]/time[3, 0], 'k--',
           TH[2:, 0], np.log(TH[2:, 0])**2*TH[2:, 0]*1e-8, 'k--',
           NN[3:10], 5e-11*NN[3:10]**2, 'k--',
           )
plt.xlabel('N')
plt.ylabel('Execution time [s]')
plt.legend(['FMM-OSX', 'FMM-Intel', 'TH-OSX', 'TH-Intel', 'Plan FMM', 'DCT-OSX', 'direct-OSX'])
